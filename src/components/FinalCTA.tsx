      ...
      <FadeIn>
        <div className="max-w-4xl mx-auto relative group">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(123,47,255,0.4), rgba(0,245,212,0.2), rgba(45,156,255,0.4))",
              filter: "blur(1px)",
            }}
          />
          <div
            ...
            style={{
              ...
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.08), inset 0 -1px 0 rgba(0,0,0,0.2), 0 0 100px rgba(123,47,255,0.08), 0 32px 80px rgba(0,0,0,0.5)",
            }}
          >
            {/* Top edge highlight */}
            ...
            <div
              ...
              style={{ background: "radial-gradient(ellipse, rgba(123,47,255,0.15) 0%, transparent 65%)" }}
            />
            {/* Corner accents */}
            <div className="absolute top-0 right-0 w-40 h-40 opacity-15" style={{ background: "radial-gradient(circle at top right, rgba(0,245,212,0.3), transparent 70%)" }} />
            <div className="absolute bottom-0 left-0 w-32 h-32 opacity-10" style={{ background: "radial-gradient(circle at bottom left, rgba(45,156,255,0.3), transparent 70%)" }} />
